...
export default class GroupJoinIterator<TOuter, TInner, TKey, TResult> extends BaseIterator<TOuter> {
    ...
    next(): IteratorResult<TResult> {
        ...
        let innerSelection = new FilterIterator(this.inner, (x, idx) => outerKey === this.innerKeySelector(x));
        let innerArray = [];
