...
var groupJoin_1 = require("../../src/linq/iterator/groupJoin");
describe("GroupJoinIterator", function () {
    it("Basic gives 1-to-1,", function () {
        ...
        var iterator = new groupJoin_1.GroupJoinIterator(parents, children, function (p) { return p.id; }, function (c) { return c.parent; }, function (p, c) {
